...
export const mockedCoursesList: Course[] = [
  {
    _id: 'de5aaa59-90f5-4dbc-b8a9-aaf205c551ba',
    title: 'JavaScript',
  ...
  {
    _id: 'b5630fdd-7bf7-4d39-b75a-2b5906fd0916',
    title: 'Angular',
    description: `Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum
	                  has been the industry's standard dummy text ever since the 1500s, when an unknown
...
export const mockedAuthorsList: Author[] = [
  {
    _id: '27cc3006-e93a-4748-8ca8-73d06aa93b6d',
    name: 'Vasiliy Dobkin',
  },
  {
    _id: 'f762978b-61eb-4096-812b-ebde22838167',
    name: 'Nicolas Kim',
  },
  {
    _id: 'df32994e-b23d-497c-9e4d-84e4dc02882f',
    name: 'Anna Sidorenko',
  },
  {
    _id: '095a1817-d45b-4ed7-9cf7-b2417bcbf748',
